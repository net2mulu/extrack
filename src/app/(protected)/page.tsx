  ...
  return (
    <div key={`dashboard-${monthKey}`} className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        >
          <div
            className={`absolute top-0 right-0 w-20 h-20 rounded-full -mr-10 -mt-10 blur-2xl ${
          ...
          <CardContent className="p-4 sm:p-5 relative">
            ...
            <div className={`text-2xl sm:text-3xl font-bold mb-1 ${balance >= 0 ? "text-green-400" : "text-red-400"}`}>
            ...
            <div className="h-3 w-full bg-secondary rounded-full overflow-hidden">
              <div
                className={`h-full transition-all duration-1000 ${
                  budgetProgress >= 100 ? "bg-red-500" : budgetProgress >= 80 ? "bg-yellow-500" : "bg-primary"
                }`}
          ...
          <div className="grid gap-3">
            {data.budgets.slice(0, 3).map((budget) => {
              ...
              return (
                <Card
                  key={budget.id}
                  className={isOverBudget ? "bg-red-500/10 border-red-500/30" : isWarning ? "bg-yellow-500/10 border-yellow-500/30" : ""}
                >
